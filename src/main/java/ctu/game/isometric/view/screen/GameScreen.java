...
import ctu.game.isometric.view.renderer.ArrowIndicator;
...
public class GameScreen implements Screen {
    ...
    public GameScreen(IsometricGame game, GameController gameController) {
        ...
        mapRenderer = new MapRenderer(gameController.getMap(), game.getAssetManager());
        ...
        arrowIndicator = new ArrowIndicator(gameController, game.getAssetManager()); // Initialize arrowIndicator
        // Set input processor
    ...
    public void render(float delta) {
        ...
        arrowIndicator.render(batch, mapRenderer.getOffsetX(), mapRenderer.getOffsetY());
