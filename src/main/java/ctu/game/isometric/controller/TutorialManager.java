...
public class TutorialManager {
    ...
    public void initializeTutorials() {
        ...
        addTutorial("combat", new Tutorial("2", "Lượt / Turn ", " - Trong lượt của bạn, chọn các chữ cái từ lưới để tạo thành từ. Nhấn 'CAST SPELL' để tấn công kẻ địch. Sát thương gây ra phụ thuộc vào độ dài và điểm số của từ." +
                "\n - Khi đến lượt kẻ địch, chúng sẽ tấn công hoặc hồi máu. Hãy chú ý thanh máu và phòng thủ của bạn để chuẩn bị cho các đòn tấn công tiếp theo.", "", "combat", false));
        addTutorial("combat", new Tutorial("3", "Máu & Năng lượng", "Thanh máu (HP) thể hiện sức khỏe của bạn. Nếu HP giảm về 0, bạn sẽ thua. Thanh năng lượng (Mana) được sử dụng để kích hoạt vật phẩm hỗ trợ.", "combat_health_mana.png", "combat", false));
        addTutorial("combat", new Tutorial("4", "Vật phẩm", "Sử dụng vật phẩm để hồi máu, tăng sức mạnh, hoặc gây sát thương đặc biệt. Nhấn vào vật phẩm trong cột bên phải để sử dụng.", "combat_items.png", "combat", false));
        addTutorial("combat", new Tutorial("6", "Cơ chế từ vựng", "Từ càng dài và phức tạp, sát thương gây ra càng cao. Các nguyên âm (A, E, I, O, U) và ký tự hiếm (Z, Q, X, J, K) sẽ tăng điểm sát thương.", "combat_word_mechanics.png", "combat", false));
        ...
        addTutorial("combat", new Tutorial("8", "Cơ chế Boss", "Khi đối đầu với Boss, chúng sẽ có sức mạnh và phòng thủ cao hơn. Một số Boss có hiệu ứng đặc biệt như vô hiệu hóa ô chữ hoặc tăng sát thương...", "combat_boss_mechanics.png", "combat", false));
        addTutorial("combat", new Tutorial("9", "Chú thích ", "Nhật ký giao chiến hiển thị các hành động trong trận đấu. Sử dụng thanh cuộn để xem lại các lượt trước đó.", "combat_log.png", "combat", false));
